...
function CandidateWrapper() {
  ...
  useEffect(() => {
    ...
    // Redirect to profile creation if profile is incomplete and not on profile-creation route
    if (!authentication_user.profile_completed && location.pathname !== '/candidate/profile-creation') {
      navigate('/candidate/profile-creation');
    }
  }, [authentication_user.isAuthenticated, authentication_user.profile_completed, location.pathname, navigate]);
  ...
  return (
    <div>
      ...
      <Routes>
        ...
        {/* Protected routes: only accessible if profile is complete */}
        {authentication_user.profile_completed && (
          <>
            <Route index element={<CandidateHome />} />
            <Route path="find-job" element={<CandidateHome />} />
            <Route path="find-job/job/:jobId" element={<JobDetail />} />
            <Route path="applyedjobs" element={<ApplyedJob />} />
            <Route path="savedjobs" element={<SavedJobs />} />
            <Route path="shedules" element={<SheduledInterviews />} /> 
