...
function Cdetails() {
    ...
    return (
            ...
            <><div className="sidebar"><Sidebar /></div><div className="content">
            {error && (
            ...
            <div className="card profile-card">
                ...
                <div className="date-section">
                    ...
                    <p><span className="label">Last Login:</span> {candidate.user.last_login ? new Date(candidate.user.last_login).toLocaleDateString() : 'Never'}</p>
                </div>
            </div>
            <div className="card">
